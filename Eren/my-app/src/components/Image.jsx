    ...
    <div className='grid h-[600px] w-full'>
      ...
      <div className="flex justify-center items-cente gap-[-200px]">   
          ...
          <div className="h-[350px] w-[350px]"><img height={10} style={{width:'240px',height:'240px'}} src={B95}></img></div>
            ...
            <div className="h-[350px] w-[350px]"><img height={10} style={{width:'240px',height:'240px'}} src={B92}></img></div>
            <div className="h-[350px] w-[350px]"><img height={10} style={{width:'240px',height:'240px'}} src={B93}></img></div>
        </div></div> 
    </div>
  )
}
